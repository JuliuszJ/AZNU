 ...
 * 2020-10-07T08:24:43.217+02:00
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "HotelBookingService",
                  wsdlLocation = "file:/home/aznu/aznu/hotel-booking/src/main/resources/hotel.wsdl",
...
public class HotelBookingService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/aznu/aznu/hotel-booking/src/main/resources/hotel.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HotelBookingService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/aznu/aznu/hotel-booking/src/main/resources/hotel.wsdl");
        }
        WSDL_LOCATION = url;
    }
